...
function SelectValue({
  ...
  return (
    <SelectPrimitive.Value
      ...
      className={cn("truncate min-w-0 block text-left", className)}
      {...props}
    />
  )
}
