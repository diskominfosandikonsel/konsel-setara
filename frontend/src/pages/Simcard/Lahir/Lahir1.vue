  ...
  <q-page class="dashboard-page">
    ...
    <div class="containerOne" style="padding-top:0px !important;">
      <div class="itemsContainer" style="padding: 0px 20px !important;">
        ...
        <div>
          <img src="~assets/simcard/firetap3.png" style="width: 90px; height: 90px;" alt="">
        </div>
      </div>
    </div>
        ...
        <div style="margin-left: 10px; margin-right: 10px;">  
            ...
            <div v-for="(item, index) in list_data" :key="index" style="padding:10px 0px 0px 10px; border-bottom: 1.5px solid #D9D9D9;">
              <div class="row items-center no-wrap">
                ...
                <div v-if="item.permohonan_KELAHIRAN.status === 0" style="color:#6C7278;">
                  <img src="~assets/simcard/wait.png" style="width: 100%; height: 56px;" alt="">
                </div>

                <div v-if="item.permohonan_KELAHIRAN.status === 1" style="color:#6C7278;">
                  <img src="~assets/simcard/succes.png" style="width: 100%; height: 56px;" alt="">
                </div>

                <div v-if="item.permohonan_KELAHIRAN.status === 2" style="color:#6C7278;">
                ...
                <div class="flex-break col self-center" style="margin-left: 11px;">
                  <div v-if="item.permohonan_KELAHIRAN.status === 0" style="color:#000000;font-size: 12px;font-weight: bold;">
                    Mohon bersabar, data masih diverifikasi
                  </div>
                  <div v-if="item.permohonan_KELAHIRAN.status === 1" style="color:#000000;font-size: 12px;font-weight: bold;">
                    Permohonan Diterima
                  </div>
                  <div v-if="item.permohonan_KELAHIRAN.status === 2" style="color:#000000;font-size: 12px;font-weight: bold;">
                    Permohonan Dikembalikan
                  </div>
                  <div style="color:#6C7278;font-size: 11px;">
                    Nama Ayah : {{ item.permohonan_KELAHIRAN.nama_ayah }}
                  </div>
                  <div style="color:#6C7278;font-size: 11px;">
                    Nama Bayi : {{ item.permohonan_KELAHIRAN.nama_bayi }}
                  </div>
                </div>
                <div class="" style="margin-left: 11px;">
                  ...
                  <div class="text-right" style="margin: 0px 0px 0px 0px ;">
                    ...
                    <!-- Button Icon -->
                    <q-btn class="text-right" v-show="item.permohonan_KELAHIRAN.email_file !== null && item.permohonan_KELAHIRAN.status_kabupaten == 1" color="primary" icon="attach_file">
                      <q-menu>
                        <q-list>
                          <q-item clickable v-close-popup @click="selectData(item), bukaLink(item.permohonan_KELAHIRAN.email_file)">
                    ...
                    <q-btn class="text-right" v-show="item.permohonan_KELAHIRAN.email_file == null && item.permohonan_KELAHIRAN.status_kabupaten == '' || item.permohonan_KELAHIRAN.status_kabupaten == 2" color="primary" icon="settings">
                      <q-menu>
                        <q-list>
                          <q-item clickable v-close-popup @click="selectData(item), modal_lihat = true ">
                            <q-item-section avatar>
                          ...
                          <q-item clickable v-show="item.permohonan_KELAHIRAN.status === 2" v-close-popup @click="selectData(item), modal_lihat_status = true ">
                            <q-item-section avatar>
      ...
      <q-card>
        ...
        <q-card-section>
          <q-stepper v-model="step" ref="stepper" color="primary" vertical animated>
            ...
            <q-step :name="2" title="Data Kartu Keluarga" caption="" icon="create_new_folder" :done="step > 2">
              <label class="text-labelku col-12 col-md-12">Nama Kepala Keluarga</label>
              <input v-model="form.nama_kepala_keluarga" class="input-form col-12 col-md-12" type="text">
              <label class="col-12 col-md-12 text-labelku ">Nomor Kartu Keluarga</label>
              <input v-model="form.no_kk" class="input-form col-12 col-md-12" type="text">     
            </q-step> 

            <q-step :name="3" title="Data Bayi / Anak" caption="" icon="create_new_folder" :done="step > 3">
              <label class="text-labelku col-12 col-md-12">Nama Bayi</label>
              <input v-model="form.nama_bayi" class="input-form col-12 col-md-12" type="text">    
              ...
              <label class="text-labelku">Tempat Dilahirkan</label>   
              <div class="custom-select" >
                <select v-model="form.tmpt_lahir_bayi"> 
                  <option >RS/RB</option>
              ...
              <template v-if="form.tmpt_lahir_bayi == 'Lainnya'">
                <input required class="input-form" v-model="form.tmpt_lahir_bayi_lainnya" type="text" placeholder="Masukan Tempat Dilahirkan Lainnya">   
              </template>   

              <label class="col-12 col-md-12 text-labelku ">Tempat Kelahiran</label>
              <input v-model="form.tempat_kelahiran_bayi" class="input-form col-12 col-md-12" type="text">     
              
              <label class="col-12 col-md-12 text-labelku ">Hari Lahir</label> 
              <select v-model="form.nama_hari" class="input-form col-12 col-md-12">
              ...
              <input v-model="form.tgl_lahir_bayi" class="input-form col-12 col-md-12" type="date">     

              <label class="col-12 col-md-12 text-labelku ">Pukul</label>
              <input v-model="form.pukul" class="input-form col-12 col-md-12" type="time">     
              ...
              <label class="col-12 col-md-12 text-labelku ">Kelahiran Ke</label>
              <input class="input-form" required v-model="form.kelahiran_ke" type="number" placeholder="Kelahiran Ke-">  

              <label class="text-labelku">Penolong Kelahiran</label>   
              <div class="custom-select" >
                <select v-model="form.penolong_kelahiran"> 
              ...
              <template v-if="form.penolong_kelahiran == 'Lainnya'">
                <input required class="input-form" v-model="form.penolong_kelahiran_lainnya" type="text" placeholder="Masukan Penolong Kelahiran Lainnya">   
              </template>
                 
              <label class="col-12 col-md-12 text-labelku ">Berat Bayi (Kg)</label>
              <input v-model="form.berat_bayi" class="input-form col-12 col-md-12" type="number">     

              <label class="col-12 col-md-12 text-labelku ">Panjang Bayi (Cm)</label>
              <input v-model="form.panjang_bayi" class="input-form col-12 col-md-12" type="number">     
            </q-step> 

            <q-step :name="4" title="Data Ibu" caption="" icon="create_new_folder" :done="step > 4">
            ...
            <q-step :name="5" title="Data Ayah" caption="" icon="create_new_folder" :done="step > 5">
                <label class="text-labelku">NIK</label>   
            ...
            <q-step :name="6" title="Data Pelapor" caption="" icon="create_new_folder" :done="step > 6">
                <label class="text-labelku">NIK</label>   
                <input class="input-form" required v-model="form.nik_pelapor" type="number" placeholder="NIK">          
                <label class="text-labelku">Nama</label>   
                <input class="input-form" required v-model="form.nama_pelapor" type="text" placeholder="Nama">          
                <label class="text-labelku">Umur</label>   
                <input class="input-form" required v-model="form.umur_pelapor" type="number" placeholder="Umur">          
                <label class="text-labelku">Pekerjaan</label>   
                <input class="input-form" required v-model="form.pekerjaan_pelapor" type="text" placeholder="Pekerjaan">

              <!-- ================= Alamat ===================== -->

              <label class="text-labelku">Alamat </label>
                <AdministrativeSelect
                  :model-value="form.provinsi_pelapor"
                  @update:model-value="form.provinsi_pelapor = $event"
                  label="Provinsi"
                  :options="list_data_provinsi_pelapor"
                  :on-filter="(val, update) => provinsi4(val, update)"
                  code-field-name="kd_provinsi"
                />

                <AdministrativeSelect
                  :model-value="form.kabupaten_pelapor"
                  @update:model-value="form.kabupaten_pelapor = $event"
                  label="Kabupaten"
                  :options="list_data_kabupaten_pelapor"
                  :on-filter="(val, update) => kabupaten4(val, update, form.provinsi_pelapor)"
                  code-field-name="kd_kabupaten"
                />

                <AdministrativeSelect
                  :model-value="form.kecamatan_pelapor"
                  @update:model-value="form.kecamatan_pelapor = $event"
                  label="Kecamatan"
                  :options="list_data_kecamatan_pelapor"
                  :on-filter="(val, update) => kecamatan4(val, update, form.kabupaten_pelapor)"
                  code-field-name="kd_kecamatan"
                />

                <AdministrativeSelect
                  :model-value="form.des_kel_pelapor"
                  @update:model-value="form.des_kel_pelapor = $event"
                  label="Desa/Kelurahan"
                  :options="list_data_desa_kelurahan_pelapor"
                  :on-filter="(val, update) => desa_kelurahan4(val, update, form.kecamatan_pelapor)"
                  code-field-name="kd_desa_kelurahan"
                />

                <label class="text-labelku">Alamat</label>   
                <input class="input-form" required v-model="form.alamat_pelapor" type="text" placeholder="Alamat Ex: Jl. Raya No. 123"> 
            </q-step> 

            <q-step :name="7" title="Data Saksi I" caption="" icon="create_new_folder" :done="step > 7">
                <label class="text-labelku">NIK</label>   
                <input class="input-form" required v-model="form.nik_saksi1" type="number" placeholder="NIK">          
                <label class="text-labelku">Nama</label>   
                <input class="input-form" required v-model="form.nama_saksi1" type="text" placeholder="Nama">          
                <label class="text-labelku">Umur</label>   
                <input class="input-form" required v-model="form.umur_saksi1" type="number" placeholder="Umur">          
                <label class="text-labelku">Pekerjaan</label>   
                <input class="input-form" required v-model="form.pekerjaan_saksi1" type="text" placeholder="Pekerjaan">

              <!-- ================= Alamat ===================== -->

              <label class="text-labelku">Alamat </label>
                <AdministrativeSelect
                  :model-value="form.provinsi_saksi1"
                  @update:model-value="form.provinsi_saksi1 = $event"
                  label="Provinsi"
                  :options="list_data_provinsi_saksi1"
                  :on-filter="(val, update) => provinsi5(val, update)"
                  code-field-name="kd_provinsi"
                />

                <AdministrativeSelect
                  :model-value="form.kabupaten_saksi1"
                  @update:model-value="form.kabupaten_saksi1 = $event"
                  label="Kabupaten"
                  :options="list_data_kabupaten_saksi1"
                  :on-filter="(val, update) => kabupaten5(val, update, form.provinsi_saksi1)"
                  code-field-name="kd_kabupaten"
                />

                <AdministrativeSelect
                  :model-value="form.kecamatan_saksi1"
                  @update:model-value="form.kecamatan_saksi1 = $event"
                  label="Kecamatan"
                  :options="list_data_kecamatan_saksi1"
                  :on-filter="(val, update) => kecamatan5(val, update, form.kabupaten_saksi1)"
                  code-field-name="kd_kecamatan"
                />

                <AdministrativeSelect
                  :model-value="form.des_kel_saksi1"
                  @update:model-value="form.des_kel_saksi1 = $event"
                  label="Desa/Kelurahan"
                  :options="list_data_desa_kelurahan_saksi1"
                  :on-filter="(val, update) => desa_kelurahan5(val, update, form.kecamatan_saksi1)"
                  code-field-name="kd_desa_kelurahan"
                />

                <label class="text-labelku">Alamat</label>   
                <input class="input-form" required v-model="form.alamat_saksi1" type="text" placeholder="Alamat Ex: Jl. Raya No. 123"> 
            </q-step> 

            <q-step :name="8" title="Data Saksi II" caption="" icon="create_new_folder" :done="step > 8">
                <label class="text-labelku">NIK</label>   
                <input class="input-form" required v-model="form.nik_saksi2" type="number" placeholder="NIK">          
                <label class="text-labelku">Nama</label>   
                <input class="input-form" required v-model="form.nama_saksi2" type="text" placeholder="Nama">          
                <label class="text-labelku">Umur</label>   
                <input class="input-form" required v-model="form.umur_saksi2" type="number" placeholder="Umur">          
                <label class="text-labelku">Pekerjaan</label>   
                <input class="input-form" required v-model="form.pekerjaan_saksi2" type="text" placeholder="Pekerjaan">

              <!-- ================= Alamat ===================== -->

              <label class="text-labelku">Alamat </label>
                <AdministrativeSelect
                  :model-value="form.provinsi_saksi2"
                  @update:model-value="form.provinsi_saksi2 = $event"
                  label="Provinsi"
                  :options="list_data_provinsi_saksi2"
                  :on-filter="(val, update) => provinsi6(val, update)"
                  code-field-name="kd_provinsi"
                />

                <AdministrativeSelect
                  :model-value="form.kabupaten_saksi2"
                  @update:model-value="form.kabupaten_saksi2 = $event"
                  label="Kabupaten"
                  :options="list_data_kabupaten_saksi2"
                  :on-filter="(val, update) => kabupaten6(val, update, form.provinsi_saksi2)"
                  code-field-name="kd_kabupaten"
                />

                <AdministrativeSelect
                  :model-value="form.kecamatan_saksi2"
                  @update:model-value="form.kecamatan_saksi2 = $event"
                  label="Kecamatan"
                  :options="list_data_kecamatan_saksi2"
                  :on-filter="(val, update) => kecamatan6(val, update, form.kabupaten_saksi2)"
                  code-field-name="kd_kecamatan"
                />

                <AdministrativeSelect
                  :model-value="form.des_kel_saksi2"
                  @update:model-value="form.des_kel_saksi2 = $event"
                  label="Desa/Kelurahan"
                  :options="list_data_desa_kelurahan_saksi2"
                  :on-filter="(val, update) => desa_kelurahan6(val, update, form.kecamatan_saksi2)"
                  code-field-name="kd_desa_kelurahan"
                />

                <label class="text-labelku">Alamat</label>   
                <input class="input-form" required v-model="form.alamat_saksi2" type="text" placeholder="Alamat Ex: Jl. Raya No. 123"> 
            </q-step> 

            <q-step :name="9" title="Data Dukung" icon="add_comment">
            ...
            <template v-slot:navigation>
              <q-stepper-navigation>
                <q-btn v-if="step < 9" @click="$refs.stepper.next()" color="primary" label="Continue" />
                <q-btn v-if="step === 9" @click="addData()" color="positive" label="Submit" :loading="loading" />
        ...
        <q-card-section>
          <q-stepper v-model="step" ref="stepper" color="primary" vertical animated>
            ...
            <template v-slot:navigation>
              <q-stepper-navigation>
                <q-btn v-if="step < 9" @click="$refs.stepper.next()" color="primary" label="Continue" />
                <q-btn v-if="step === 9" @click="editData()" color="positive" label="Submit" :loading="loading" />
                <q-btn v-if="step > 1" flat color="primary" @click="$refs.stepper.previous()" label="Back"
                  class="q-ml-sm" />
              </q-stepper-navigation>
            </template>
      ...
      <q-card style="min-width: 95%; max-width: 95%;">
        <q-toolbar>
          <q-toolbar-title>
            ...
            <span class="text-weight-bold">Detail Permohonan Kelahiran</span>
          </q-toolbar-title>
          <q-btn flat round dense icon="close" v-close-popup />
        </q-toolbar>
            ...
            <div class="q-gutter-lg">
              ...
              <div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                  ...
                  <div>
                    ...
                    <div style="font-size: 14px; color: #2d3748;">{{ form.nama_kepala_keluarga || '-' }}</div>
                  </div>
                </div>
              </div>

              <!-- Bagian 3: Data Bayi/Anak -->
              <div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Nama Bayi</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.nama_bayi || '-' }}</div>
                  </div>
                  <div>
                  ...
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Tempat Dilahirkan</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.tmpt_lahir_bayi || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Lokasi Kelahiran</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.tempat_kelahiran_bayi || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Hari Lahir</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.nama_hari || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Tanggal Lahir</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.tgl_lahir_bayi || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Pukul</div>
                  ...
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Kelahiran Ke</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.kelahiran_ke || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Penolong Kelahiran</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.penolong_kelahiran || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Berat Bayi (Kg)</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.berat_bayi || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Panjang Bayi (Cm)</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.panjang_bayi || '-' }}</div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                  ...
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Tanggal Catatan Perkawinan</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.tgl_catatan_perkawinan || '-' }}</div>
                  </div>
              ...
              <div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">NIK</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.nik_pelapor || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Nama</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.nama_pelapor || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Umur</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.umur_pelapor || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Pekerjaan</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.pekerjaan_pelapor || '-' }}</div>
                  </div>
                  <div style="grid-column: 1 / -1;">
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Alamat</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.alamat_pelapor || '-' }}</div>
                  </div>
                </div>
              </div>

              <!-- Bagian 7: Data Saksi I -->
              <div>
                <h5 style="margin: 0 0 16px 0; color: #7B1FA2; border-bottom: 2px solid #7B1FA2; padding-bottom: 8px;">
                  🔍 Data Saksi I
                </h5>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">NIK</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.nik_saksi1 || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Nama</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.nama_saksi1 || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Umur</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.umur_saksi1 || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Pekerjaan</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.pekerjaan_saksi1 || '-' }}</div>
                  </div>
                  <div style="grid-column: 1 / -1;">
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Alamat</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.alamat_saksi1 || '-' }}</div>
                  </div>
                </div>
              </div>

              <!-- Bagian 8: Data Saksi II -->
              <div>
                <h5 style="margin: 0 0 16px 0; color: #7B1FA2; border-bottom: 2px solid #7B1FA2; padding-bottom: 8px;">
                  🔍 Data Saksi II
                </h5>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">NIK</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.nik_saksi2 || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Nama</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.nama_saksi2 || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Umur</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.umur_saksi2 || '-' }}</div>
                  </div>
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Pekerjaan</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.pekerjaan_saksi2 || '-' }}</div>
                  </div>
                  <div style="grid-column: 1 / -1;">
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Alamat</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.alamat_saksi2 || '-' }}</div>
                  </div>
                </div>
              </div>

              <!-- Bagian 9: File Lampiran -->
              <div>
...
export default {
  ...
  name: 'permohonan_KELAHIRAN_list',
  data() {
    return {
      FetchingUmum: FetchingUmum,
      nama_form:'permohonan_KELAHIRAN',
      nama:'',
      step: 1,
      modal_lihat   : false,
      modal_add   : false,
  ...
  methods: {
    ...
    getview() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KELAHIRAN + "view",
        payload,
        {
          headers: {
    ...
    addData() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KELAHIRAN + "addData",
        formData,
        {
          headers: {
            authorization: "kikensbatara " + this.token
    ...
    editData() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KELAHIRAN + "editData_mobile",
        formData,
        {
          headers: {
            authorization: "kikensbatara " + this.token
    ...
    removeData() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KELAHIRAN + "removeData",
        body,
        {
          headers: {
    ...
    selectData(data){
      ...
      this.isLoadingData = true
          ...
          this.form.id = data.permohonan_KELAHIRAN.id;

          this.form.modul                         = data.permohonan_KELAHIRAN.modul;
          this.form.m_provinsi                    = data.permohonan_KELAHIRAN.m_provinsi;
          this.form.m_kabupaten                   = data.permohonan_KELAHIRAN.m_kabupaten;
          this.form.m_kecamatan                   = data.permohonan_KELAHIRAN.m_kecamatan;
          this.form.m_desa_kelurahan              = data.permohonan_KELAHIRAN.m_desa_kelurahan;
          this.form.nama_kepala_keluarga          = data.permohonan_KELAHIRAN.nama_kepala_keluarga;
          this.form.no_kk                         = data.permohonan_KELAHIRAN.no_kk;

          this.form.nama_bayi                     = data.permohonan_KELAHIRAN.nama_bayi;
          this.form.jenis_kelamin_bayi            = data.permohonan_KELAHIRAN.jenis_kelamin_bayi;
          this.form.tmpt_lahir_bayi               = data.permohonan_KELAHIRAN.tmpt_lahir_bayi;
          this.form.tmpt_lahir_bayi_lainnya       = data.permohonan_KELAHIRAN.tmpt_lahir_bayi_lainnya;
          this.form.tempat_kelahiran_bayi         = data.permohonan_KELAHIRAN.tempat_kelahiran_bayi;
          this.form.nama_hari                     = data.permohonan_KELAHIRAN.nama_hari;
          this.form.tgl_lahir_bayi                = data.permohonan_KELAHIRAN.tgl_lahir_bayi;
          this.form.pukul                         = data.permohonan_KELAHIRAN.pukul;
          this.form.jenis_lahir                   = data.permohonan_KELAHIRAN.jenis_lahir;
          this.form.jenis_lahir_lainnya           = data.permohonan_KELAHIRAN.jenis_lahir_lainnya;
          this.form.kelahiran_ke                  = data.permohonan_KELAHIRAN.kelahiran_ke;
          this.form.penolong_kelahiran            = data.permohonan_KELAHIRAN.penolong_kelahiran;
          this.form.penolong_kelahiran_lainnya    = data.permohonan_KELAHIRAN.penolong_kelahiran_lainnya;
          this.form.berat_bayi                    = data.permohonan_KELAHIRAN.berat_bayi;
          this.form.panjang_bayi                  = data.permohonan_KELAHIRAN.panjang_bayi;

          this.form.nik_ibu                       = data.permohonan_KELAHIRAN.nik_ibu;
          this.form.nama_ibu                      = data.permohonan_KELAHIRAN.nama_ibu;
          this.form.tgl_lahir_ibu                 = data.permohonan_KELAHIRAN.tgl_lahir_ibu;
          this.form.pekerjaan_ibu                 = data.permohonan_KELAHIRAN.pekerjaan_ibu;
          this.form.provinsi_ibu                  = data.permohonan_KELAHIRAN.provinsi_ibu;
          this.form.kabupaten_ibu                 = data.permohonan_KELAHIRAN.kabupaten_ibu;
          this.form.kecamatan_ibu                 = data.permohonan_KELAHIRAN.kecamatan_ibu;
          this.form.des_kel_ibu                   = data.permohonan_KELAHIRAN.des_kel_ibu;
          this.form.alamat_ibu                    = data.permohonan_KELAHIRAN.alamat_ibu;
          this.form.kewarganegaraan_ibu           = data.permohonan_KELAHIRAN.kewarganegaraan_ibu;
          this.form.kewarganegaraan_ibu_lainnya   = data.permohonan_KELAHIRAN.kewarganegaraan_ibu_lainnya;
          this.form.tgl_catatan_perkawinan        = data.permohonan_KELAHIRAN.tgl_catatan_perkawinan;

          this.form.nik_ayah                      = data.permohonan_KELAHIRAN.nik_ayah;
          this.form.nama_ayah                     = data.permohonan_KELAHIRAN.nama_ayah;
          this.form.tgl_lahir_ayah                = data.permohonan_KELAHIRAN.tgl_lahir_ayah;
          this.form.pekerjaan_ayah                = data.permohonan_KELAHIRAN.pekerjaan_ayah;
          this.form.provinsi_ayah                 = data.permohonan_KELAHIRAN.provinsi_ayah;
          this.form.kabupaten_ayah                = data.permohonan_KELAHIRAN.kabupaten_ayah;
          this.form.kecamatan_ayah                = data.permohonan_KELAHIRAN.kecamatan_ayah;
          this.form.des_kel_ayah                  = data.permohonan_KELAHIRAN.des_kel_ayah;
          this.form.alamat_ayah                   = data.permohonan_KELAHIRAN.alamat_ayah;
          this.form.kewarganegaraan_ayah          = data.permohonan_KELAHIRAN.kewarganegaraan_ayah;
          this.form.kewarganegaraan_ayah_lainnya  = data.permohonan_KELAHIRAN.kewarganegaraan_ayah_lainnya;

          this.form.nik_pelapor         = data.permohonan_KELAHIRAN.nik_pelapor;
          this.form.nama_pelapor        = data.permohonan_KELAHIRAN.nama_pelapor;
          this.form.umur_pelapor        = data.permohonan_KELAHIRAN.umur_pelapor;
          this.form.pekerjaan_pelapor   = data.permohonan_KELAHIRAN.pekerjaan_pelapor;
          this.form.provinsi_pelapor    = data.permohonan_KELAHIRAN.provinsi_pelapor;
          this.form.kabupaten_pelapor   = data.permohonan_KELAHIRAN.kabupaten_pelapor;
          this.form.kecamatan_pelapor   = data.permohonan_KELAHIRAN.kecamatan_pelapor;
          this.form.des_kel_pelapor     = data.permohonan_KELAHIRAN.des_kel_pelapor;
          this.form.alamat_pelapor      = data.permohonan_KELAHIRAN.alamat_pelapor;

          this.form.nik_saksi1            = data.permohonan_KELAHIRAN.nik_saksi1;
          this.form.nama_saksi1           = data.permohonan_KELAHIRAN.nama_saksi1;
          this.form.umur_saksi1           = data.permohonan_KELAHIRAN.umur_saksi1;
          this.form.pekerjaan_saksi1      = data.permohonan_KELAHIRAN.pekerjaan_saksi1;
          this.form.provinsi_saksi1       = data.permohonan_KELAHIRAN.provinsi_saksi1;
          this.form.kabupaten_saksi1      = data.permohonan_KELAHIRAN.kabupaten_saksi1;
          this.form.kecamatan_saksi1      = data.permohonan_KELAHIRAN.kecamatan_saksi1;
          this.form.des_kel_saksi1        = data.permohonan_KELAHIRAN.des_kel_saksi1;
          this.form.alamat_saksi1         = data.permohonan_KELAHIRAN.alamat_saksi1;

          this.form.nik_saksi2            = data.permohonan_KELAHIRAN.nik_saksi2;
          this.form.nama_saksi2           = data.permohonan_KELAHIRAN.nama_saksi2;
          this.form.umur_saksi2           = data.permohonan_KELAHIRAN.umur_saksi2;
          this.form.pekerjaan_saksi2      = data.permohonan_KELAHIRAN.pekerjaan_saksi2;
          this.form.provinsi_saksi2       = data.permohonan_KELAHIRAN.provinsi_saksi2;
          this.form.kabupaten_saksi2      = data.permohonan_KELAHIRAN.kabupaten_saksi2;
          this.form.kecamatan_saksi2      = data.permohonan_KELAHIRAN.kecamatan_saksi2;
          this.form.des_kel_saksi2        = data.permohonan_KELAHIRAN.des_kel_saksi2;
          this.form.alamat_saksi2         = data.permohonan_KELAHIRAN.alamat_saksi2;

          this.form.status                = data.permohonan_KELAHIRAN.status
          this.form.keterangan            = data.permohonan_KELAHIRAN.keterangan
          this.form.keterangan_deskel     = data.permohonan_KELAHIRAN.keterangan_deskel
          this.form.keterangan_kecamatan  = data.permohonan_KELAHIRAN.keterangan_kecamatan
          this.form.keterangan_kabupaten  = data.permohonan_KELAHIRAN.keterangan_kabupaten
          this.form.status_deskel         = data.permohonan_KELAHIRAN.status_deskel
          this.form.status_kecamatan      = data.permohonan_KELAHIRAN.status_kecamatan
          this.form.status_kabupaten      = data.permohonan_KELAHIRAN.status_kabupaten
          this.form.createdAt_deskel      = data.permohonan_KELAHIRAN.createdAt_deskel
          this.form.createdAt_kecamatan   = data.permohonan_KELAHIRAN.createdAt_kecamatan
          this.form.createdAt_kabupaten   = data.permohonan_KELAHIRAN.createdAt_kabupaten

          this.form.createdBy             = data.permohonan_KELAHIRAN.createdBy
 
          this.form.file_lampiran         = data.permohonan_KELAHIRAN.file_lampiran
          this.form.file_lampiranOld      = data.permohonan_KELAHIRAN.file_lampiranOld

          this.form.emailPemohon          = data.permohonan_KELAHIRAN.emailPemohon; 

          // this.form.email_file    = data.permohonan_KTP.email_file;
          this.form.email_fileOld = data.permohonan_KELAHIRAN.email_file;
          this.form.email_from    = this.form.email_from;
          this.form.email_to      = this.form.emailPemohon;
          this.form.email_subject = data.permohonan_KELAHIRAN.email_subject;
          this.form.email_html    = data.permohonan_KELAHIRAN.email_html;
          
          this.fileOld            = data.permohonan_KELAHIRAN.file;
          this.fileOldThumb       = data.permohonan_KELAHIRAN.fileThumb;
        ...
        this.wilayahPelapor = {
          uraian_provinsi       : data.wilayah_provinsi_pelapor.uraian,
          kd_provinsi           : data.wilayah_provinsi_pelapor.kd_provinsi,
          uraian_kabupaten      : data.wilayah_kabupaten_pelapor.uraian,
          kd_kabupaten          : data.wilayah_kabupaten_pelapor.kd_kabupaten,
          uraian_kecamatan      : data.wilayah_kecamatan_pelapor.uraian,
          kd_kecamatan          : data.wilayah_kecamatan_pelapor.kd_kecamatan,
          uraian_desa_kelurahan : data.wilayah_deskel_pelapor.uraian,
          kd_desa_kelurahan     : data.wilayah_deskel_pelapor.kd_desa_kelurahan,
        };
        this.wilayahSaksi1 = {
          uraian_provinsi       : data.wilayah_provinsi_saksi1.uraian,
          kd_provinsi           : data.wilayah_provinsi_saksi1.kd_provinsi,
          uraian_kabupaten      : data.wilayah_kabupaten_saksi1.uraian,
          kd_kabupaten          : data.wilayah_kabupaten_saksi1.kd_kabupaten,
          uraian_kecamatan      : data.wilayah_kecamatan_saksi1.uraian,
          kd_kecamatan          : data.wilayah_kecamatan_saksi1.kd_kecamatan,
          uraian_desa_kelurahan : data.wilayah_deskel_saksi1.uraian,
          kd_desa_kelurahan     : data.wilayah_deskel_saksi1.kd_desa_kelurahan,
        };
        this.wilayahSaksi2 = {
          uraian_provinsi       : data.wilayah_provinsi_saksi2.uraian,
          kd_provinsi           : data.wilayah_provinsi_saksi2.kd_provinsi,
          uraian_kabupaten      : data.wilayah_kabupaten_saksi2.uraian,
          kd_kabupaten          : data.wilayah_kabupaten_saksi2.kd_kabupaten,
          uraian_kecamatan      : data.wilayah_kecamatan_saksi2.uraian,
          kd_kecamatan          : data.wilayah_kecamatan_saksi2.kd_kecamatan,
          uraian_desa_kelurahan : data.wilayah_deskel_saksi2.uraian,
          kd_desa_kelurahan     : data.wilayah_deskel_saksi2.kd_desa_kelurahan,
        };
    ...
    cekButton_status_kecamatan: function(data){  
      var a = data.permohonan_KELAHIRAN.status 
      var status_kab = data.permohonan_KELAHIRAN.status_kabupaten  
