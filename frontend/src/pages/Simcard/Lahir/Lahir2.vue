        ...
        <div style="margin-left: 10px; margin-right: 10px;">  
            ...
            <div v-for="(item, index) in list_data" :key="index" style="padding:10px 0px 0px 10px; border-bottom: 1.5px solid #D9D9D9;">
              <div class="row items-center no-wrap">
                ...
                <div v-if="item.permohonan_KELAHIRAN_aytdau.status === 0" style="color:#6C7278;">
                  <img src="~assets/simcard/wait.png" style="width: 100%; height: 56px;" alt="">
                </div>

                <div v-if="item.permohonan_KELAHIRAN_aytdau.status === 1" style="color:#6C7278;">
                  <img src="~assets/simcard/succes.png" style="width: 100%; height: 56px;" alt="">
                </div>

                <div v-if="item.permohonan_KELAHIRAN_aytdau.status === 2" style="color:#6C7278;">
                ...
                <div class="flex-break col self-center" style="margin-left: 11px;">
                  <div v-if="item.permohonan_KELAHIRAN_aytdau.status === 0" style="color:#000000;font-size: 12px;font-weight: bold;">
                    Mohon bersabar, data masih diverifikasi
                  </div>
                  <div v-if="item.permohonan_KELAHIRAN_aytdau.status === 1" style="color:#000000;font-size: 12px;font-weight: bold;">
                    Permohonan Diterima
                  </div>
                  <div v-if="item.permohonan_KELAHIRAN_aytdau.status === 2" style="color:#000000;font-size: 12px;font-weight: bold;">
                    Permohonan Dikembalikan
                  </div>
                  <div style="color:#6C7278;font-size: 11px;">
                    Nama Ayah : {{ item.permohonan_KELAHIRAN_aytdau.nama_ayah }}
                  </div>
                  <div style="color:#6C7278;font-size: 11px;">
                    Nama Bayi : {{ item.permohonan_KELAHIRAN_aytdau.nama_bayi }}
                  </div>
                </div>
                <div class="" style="margin-left: 11px;">
                  ...
                  <div class="text-right" style="margin: 0px 0px 0px 0px ;">
                    ...
                    <!-- Button Icon -->
                    <q-btn class="text-right" v-show="item.permohonan_KELAHIRAN_aytdau.email_file !== null && item.permohonan_KELAHIRAN_aytdau.status_kabupaten == 1" color="primary" icon="attach_file">
                      <q-menu>
                        <q-list>
                          <q-item clickable v-close-popup @click="selectData(item), bukaLink(item.permohonan_KELAHIRAN_aytdau.email_file)">
                    ...
                    <q-btn class="text-right" v-show="item.permohonan_KELAHIRAN_aytdau.email_file == null && item.permohonan_KELAHIRAN_aytdau.status_kabupaten == '' || item.permohonan_KELAHIRAN_aytdau.status_kabupaten == 2" color="primary" icon="settings">
                      <q-menu>
                        <q-list>
                          <q-item clickable v-close-popup @click="selectData(item), modal_lihat = true ">
                            <q-item-section avatar>
                          ...
                          <q-item clickable v-show="item.permohonan_KELAHIRAN_aytdau.status === 2" v-close-popup @click="selectData(item), modal_lihat_status = true ">
                            <q-item-section avatar>
      ...
      <q-card>
        ...
        <q-card-section>
          <q-stepper v-model="step" ref="stepper" color="primary" vertical animated>
            ...
            <q-step :name="2" title="Data Bayi / Anak" caption="" icon="create_new_folder" :done="step > 2">
            ...
            <q-step :name="3" title="Data Pelapor" caption="" icon="create_new_folder" :done="step > 3">
            ...
            <q-step :name="4" title="Data Saksi I" caption="" icon="create_new_folder" :done="step > 4">
                <label class="text-labelku">NIK</label>   
            ...
            <q-step :name="5" title="Data Saksi II" caption="" icon="create_new_folder" :done="step > 5">
                <label class="text-labelku">NIK</label>   
...
export default {
  ...
  name: 'permohonan_KELAHIRAN_aytdau_list',
  data() {
    return {
      FetchingUmum: FetchingUmum,
      nama_form:'permohonan_KELAHIRAN_aytdau',
      nama:'',
      step: 1,
      modal_lihat   : false,
      modal_add   : false,
  ...
  methods: {
    ...
    getview() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KELAHIRAN_AYTDAU + "view",
        payload,
        {
          headers: {
    ...
    addData() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KELAHIRAN_AYTDAU + "addData",
        formData,
        {
          headers: {
            authorization: "kikensbatara " + this.token
    ...
    editData() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KELAHIRAN_AYTDAU + "editData_mobile",
        formData,
        {
          headers: {
            authorization: "kikensbatara " + this.token
    ...
    removeData() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KELAHIRAN_AYTDAU + "removeData",
        body,
        {
          headers: {
    ...
    selectData(data){
      ...
      this.isLoadingData = true
          ...
          this.form.id = data.permohonan_KELAHIRAN_aytdau.id;

          this.form.status_kecamatan                   = data.permohonan_KELAHIRAN_aytdau.status_kecamatan;
          this.form.status_kabupaten                    = data.permohonan_KELAHIRAN_aytdau.status_kabupaten;

          this.form.modul                         = data.permohonan_KELAHIRAN_aytdau.modul;
          this.form.m_provinsi                    = data.permohonan_KELAHIRAN_aytdau.m_provinsi;
          this.form.m_kabupaten                   = data.permohonan_KELAHIRAN_aytdau.m_kabupaten;
          this.form.m_kecamatan                   = data.permohonan_KELAHIRAN_aytdau.m_kecamatan;
          this.form.m_desa_kelurahan              = data.permohonan_KELAHIRAN_aytdau.m_desa_kelurahan;
          
          

          this.form.nama_bayi                     = data.permohonan_KELAHIRAN_aytdau.nama_bayi;
          this.form.jenis_kelamin_bayi            = data.permohonan_KELAHIRAN_aytdau.jenis_kelamin_bayi; 
          this.form.tempat_kelahiran_bayi         = data.permohonan_KELAHIRAN_aytdau.tempat_kelahiran_bayi;
          this.form.nama_hari                     = data.permohonan_KELAHIRAN_aytdau.nama_hari;
          this.form.tgl_lahir_bayi                = data.permohonan_KELAHIRAN_aytdau.tgl_lahir_bayi;
          this.form.pukul                         = data.permohonan_KELAHIRAN_aytdau.pukul;   
          this.form.berat_bayi                    = data.permohonan_KELAHIRAN_aytdau.berat_bayi;
          this.form.panjang_bayi                  = data.permohonan_KELAHIRAN_aytdau.panjang_bayi;

  
          this.form.nik_pelapor         = data.permohonan_KELAHIRAN_aytdau.nik_pelapor;
          this.form.nama_pelapor        = data.permohonan_KELAHIRAN_aytdau.nama_pelapor;
          this.form.umur_pelapor        = data.permohonan_KELAHIRAN_aytdau.umur_pelapor;
          this.form.pekerjaan_pelapor   = data.permohonan_KELAHIRAN_aytdau.pekerjaan_pelapor;
          this.form.provinsi_pelapor    = data.permohonan_KELAHIRAN_aytdau.provinsi_pelapor;
          this.form.kabupaten_pelapor   = data.permohonan_KELAHIRAN_aytdau.kabupaten_pelapor;
          this.form.kecamatan_pelapor   = data.permohonan_KELAHIRAN_aytdau.kecamatan_pelapor;
          this.form.des_kel_pelapor     = data.permohonan_KELAHIRAN_aytdau.des_kel_pelapor;
          this.form.alamat_pelapor      = data.permohonan_KELAHIRAN_aytdau.alamat_pelapor;

          this.form.nik_saksi1            = data.permohonan_KELAHIRAN_aytdau.nik_saksi1;
          this.form.nama_saksi1           = data.permohonan_KELAHIRAN_aytdau.nama_saksi1;
          this.form.umur_saksi1           = data.permohonan_KELAHIRAN_aytdau.umur_saksi1;
          this.form.pekerjaan_saksi1      = data.permohonan_KELAHIRAN_aytdau.pekerjaan_saksi1;
          this.form.provinsi_saksi1       = data.permohonan_KELAHIRAN_aytdau.provinsi_saksi1;
          this.form.kabupaten_saksi1      = data.permohonan_KELAHIRAN_aytdau.kabupaten_saksi1;
          this.form.kecamatan_saksi1      = data.permohonan_KELAHIRAN_aytdau.kecamatan_saksi1;
          this.form.des_kel_saksi1        = data.permohonan_KELAHIRAN_aytdau.des_kel_saksi1;
          this.form.alamat_saksi1         = data.permohonan_KELAHIRAN_aytdau.alamat_saksi1;

          this.form.nik_saksi2            = data.permohonan_KELAHIRAN_aytdau.nik_saksi2;
          this.form.nama_saksi2           = data.permohonan_KELAHIRAN_aytdau.nama_saksi2;
          this.form.umur_saksi2           = data.permohonan_KELAHIRAN_aytdau.umur_saksi2;
          this.form.pekerjaan_saksi2      = data.permohonan_KELAHIRAN_aytdau.pekerjaan_saksi2;
          this.form.provinsi_saksi2       = data.permohonan_KELAHIRAN_aytdau.provinsi_saksi2;
          this.form.kabupaten_saksi2      = data.permohonan_KELAHIRAN_aytdau.kabupaten_saksi2;
          this.form.kecamatan_saksi2      = data.permohonan_KELAHIRAN_aytdau.kecamatan_saksi2;
          this.form.des_kel_saksi2        = data.permohonan_KELAHIRAN_aytdau.des_kel_saksi2;
          this.form.alamat_saksi2         = data.permohonan_KELAHIRAN_aytdau.alamat_saksi2;

          this.form.keterangan_deskel     = data.permohonan_KELAHIRAN_aytdau.keterangan_deskel;
          this.form.keterangan_kecamatan  = data.permohonan_KELAHIRAN_aytdau.keterangan_kecamatan;
          this.form.keterangan_kabupaten  = data.permohonan_KELAHIRAN_aytdau.keterangan_kabupaten;
          this.form.status                = data.permohonan_KELAHIRAN_aytdau.status;
          this.form.keterangan            = data.permohonan_KELAHIRAN_aytdau.keterangan; 

          this.form.file_lampiran         = data.permohonan_KELAHIRAN_aytdau.file_lampiran; 
          this.form.file_lampiranOld      = data.permohonan_KELAHIRAN_aytdau.file_lampiranOld; 

          this.form.createdBy      = data.permohonan_KELAHIRAN_aytdau.createdBy; 

              
            
          // this.form.email_file    = data.permohonan_KTP.email_file;

          this.form.emailPemohon  = data.permohonan_KELAHIRAN_aytdau.emailPemohon;
          this.form.email_fileOld = data.permohonan_KELAHIRAN_aytdau.email_file;
          this.form.email_from    = this.form.email_from;
          this.form.email_to      = this.form.emailPemohon;
          this.form.email_subject = data.permohonan_KELAHIRAN_aytdau.email_subject;
          if (data.permohonan_KELAHIRAN_aytdau.email_html == undefined || data.permohonan_KELAHIRAN_aytdau.email_html == null || data.permohonan_KELAHIRAN_aytdau.email_html == '') {
            this.form.email_html    = ''
          } else {
            this.form.email_html    = data.permohonan_KELAHIRAN_aytdau.email_html; 
          }
          
          this.fileOld            = data.permohonan_KELAHIRAN_aytdau.file;
          this.fileOldThumb       = data.permohonan_KELAHIRAN_aytdau.fileThumb;          
    ...
    cekButton_status_kecamatan: function(data){  
      var a = data.permohonan_KELAHIRAN_aytdau.status 
      var status_kab = data.permohonan_KELAHIRAN_aytdau.status_kabupaten  
