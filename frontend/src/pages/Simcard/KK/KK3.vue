        ...
        <div style="margin-left: 10px; margin-right: 10px;">  
            ...
            <div v-for="(item, index) in list_data" :key="index" style="padding:10px 0px 0px 10px; border-bottom: 1.5px solid #D9D9D9;">
              <div class="row items-center no-wrap">
                ...
                <div v-if="item.KK3.status === 0" style="color:#6C7278;">
                  <img src="~assets/simcard/wait.png" style="width: 100%; height: 56px;" alt="">
                </div>

                <div v-if="item.KK3.status === 1" style="color:#6C7278;">
                  <img src="~assets/simcard/succes.png" style="width: 100%; height: 56px;" alt="">
                </div>

                <div v-if="item.KK3.status === 2" style="color:#6C7278;">
                ...
                <div class="flex-break col self-center" style="margin-left: 11px;">
                  <div v-if="item.KK3.status === 0" style="color:#000000;font-size: 12px;font-weight: bold;">
                    Mohon bersabar, data masih diverifikasi
                  </div>
                  <div v-if="item.KK3.status === 1" style="color:#000000;font-size: 12px;font-weight: bold;">
                    Permohonan Diterima
                  </div>
                  <div v-if="item.KK3.status === 2" style="color:#000000;font-size: 12px;font-weight: bold;">
                    Permohonan Dikembalikan
                  </div>
                  <div style="color:#6C7278;font-size: 11px;">
                    Nama pemohon : {{ item.KK3.nama }}
                  </div>
                </div>
                <div class="" style="margin-left: 11px;">
                  ...
                  <div class="text-right" style="margin: 0px 0px 0px 0px ;">
                    ...
                    <!-- Button Icon -->
                    <q-btn class="text-right" v-show="item.KK3.email_file !== null && item.KK3.status_kabupaten == 1" color="primary" icon="attach_file">
                      <q-menu>
                        <q-list>
                          <q-item clickable v-close-popup @click="selectData(item), bukaLink(item.KK3.email_file)">
                    ...
                    <q-btn class="text-right" v-show="item.KK3.email_file == null && item.KK3.status_kabupaten == '' || item.KK3.status_kabupaten == 2" color="primary" icon="settings">
                      <q-menu>
                        <q-list>
                          <q-item clickable v-close-popup @click="selectData(item), modal_lihat = true ">
                            <q-item-section avatar>
                          ...
                          <q-item clickable v-show="item.KK3.status === 2" v-close-popup @click="selectData(item), modal_lihat_status = true ">
                            <q-item-section avatar>
            ...
            <q-step :name="2" title="Data Pemohon" caption="" icon="create_new_folder" :done="step > 2">
              <div class="q-pa-md">
                ...
                <div class="q-gutter-sm txkecil" inline>
                  <q-radio size="xs" v-model="form.permohonan" val="Perubahan Status Kewarganegaraan dari Izin Tinggal Terbatas menjadi Izin Tinggal Tetap " label="Perubahan Status Kewarganegaraan dari Izin Tinggal Terbatas menjadi Izin Tinggal Tetap" />
              ...
              <label class="text-labelku">Status Hubungan Dalam Keluarga {{ form.shdk }}</label>
              <select v-model="form.shdk" class="input-form">
              ...
              <template v-if="form.shdk == 'Lainnya'">
                  <label class="text-labelku">SHDK Lainnya</label> 
                  <input class="input-form" v-model="form.shdk_lainnya" type="text" placeholder="SHDK Lainnya">
              </template>
              ...
              <input v-model="form.Telepon" type="tel" placeholder="Nomor Telepon" class="input-form">

              <!-- ================= Alamat ===================== -->
            </q-step> 

            <q-step :name="3" title="Data KITAP (Kartu Izin Tinggal Tetap)" icon="add_comment" :done="step > 3">
                <label class="text-labelku">Nomor KITAP</label>   
                <input class="input-form" v-model="form.no_kitap" type="text" placeholder="Nomor KITAP">  
                <label class="text-labelku">Tanggal Berakhir KITAP</label>   
                <input  class="input-form" v-model="form.tgl_berakhir_kitap" type="date" placeholder="TANGGAL Berakhir KITAP">
            </q-step>
            ...
            <div class="q-gutter-lg">
              ...
              <div>
                <h5 style="margin: 0 0 16px 0; color: #1976D2; border-bottom: 2px solid #1976D2; padding-bottom: 8px;">
                  📍 Daerah Administratif Permohonan
                </h5>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Provinsi</div>
                    <div style="font-size: 14px; color: #2d3748; font-weight: 600;">{{ wilayah.uraian_provinsi || '-' }}</div>
                  ...
                  <div>
                    ...
                    <div style="font-size: 14px; color: #2d3748; font-weight: 600;">{{ wilayah.uraian_kabupaten || '-' }}</div>
                  ...
                  <div>
                    ...
                    <div style="font-size: 14px; color: #2d3748; font-weight: 600;">{{ wilayah.uraian_kecamatan || '-' }}</div>
                  ...
                  <div>
                    ...
                    <div style="font-size: 14px; color: #2d3748; font-weight: 600;">{{ wilayah.uraian_desa_kelurahan || '-' }}</div>
              ...
              <div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                  ...
                  <div>
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">No. HP</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.no_hp || '-' }}</div>
                  </div>
                  <div v-if="form.no_kitap">
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">No. KITAP</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.no_kitap || '-' }}</div>
                  </div>
                  <div v-if="form.tgl_berakhir_kitap">
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Tanggal Berakhir KITAP</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.tgl_berakhir_kitap || '-' }}</div>
                  </div>
                </div>
              </div>
              ...
              <div v-if="form.no_kk_lama">
                ...
                <div style="display: grid; gap: 16px;">
                  ...
                  <!-- Telepon Lama -->
                  <div v-if="form.telepon_lama">
                    <div style="font-size: 12px; font-weight: 500; color: #718096; margin-bottom: 4px;">Telepon Lama</div>
                    <div style="font-size: 14px; color: #2d3748;">{{ form.telepon_lama || '-' }}</div>
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    getview() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KK_WNA + "view",
        payload,
        {
          headers: {
    ...
    addData() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KK_WNA + "addData1",
        formData,
        {
          headers: {
            authorization: "kikensbatara " + this.token
    ...
    editData() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KK_WNA + "editData",
        formData,
        {
          headers: {
            authorization: "kikensbatara " + this.token
    ...
    removeData() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KK_WNA + "removeData_mobile",
        body,
        {
          headers: {
            authorization: "kikensbatara " + this.token
    ...
    selectData(data){
      ...
      // ===== IDENTITAS DASAR =====
      this.form.id = data.KK3.id
      this.form.KKref = data.KK3.KKref
      this.form.id_dari_form = data.KK3.id_dari_form

      // ===== DAERAH ADMINISTRATIF PERMOHONAN =====
      this.form.m_provinsi = data.KK3.m_provinsi 
      this.form.m_kabupaten = data.KK3.m_kabupaten 
      this.form.m_kecamatan = data.KK3.m_kecamatan
      this.form.m_desa_kelurahan = data.KK3.m_desa_kelurahan

      // ===== ALASAN PERMOHONAN =====
      this.form.permohonan = data.KK3.permohonan
      this.form.permohonan_lainnya = data.KK3.permohonan_lainnya

      // ===== DATA PEMOHON =====
      this.form.nama = data.KK3.nama
      this.form.nik = data.KK3.nik
      this.form.no_kk = data.KK3.no_kk
      this.form.shdk = data.KK3.shdk
      this.form.shdk_lainnya = data.KK3.shdk_lainnya
      this.form.jenis_kelamin = data.KK3.jenis_kelamin
      this.form.tempat_lahir = data.KK3.tempat_lahir
      this.form.tanggal_lahir = data.KK3.tanggal_lahir
      this.form.status_hubungan_dl_keluarga = data.KK3.status_hubungan_dl_keluarga
      this.form.agama = data.KK3.agama
      this.form.agama_lainnya = data.KK3.agama_lainnya
      this.form.pekerjaan = data.KK3.pekerjaan
      this.form.pekerjaan_lainnya = data.KK3.pekerjaan_lainnya
      this.form.pendidikan = data.KK3.pendidikan
      this.form.pendidikan_lainnya = data.KK3.pendidikan_lainnya
      this.form.no_hp = data.KK3.no_hp

      // ===== DATA KITAP =====
      this.form.no_kitap = data.KK3.no_kitap
      this.form.tgl_berakhir_kitap = data.KK3.tgl_berakhir_kitap

      // ===== ALAMAT PEMOHON =====
      this.form.provinsi = data.KK3.provinsi
      this.form.kabupaten = data.KK3.kabupaten
      this.form.kecamatan = data.KK3.kecamatan 
      this.form.desa_kelurahan = data.KK3.desa_kelurahan
      this.form.alamat = data.KK3.alamat
      this.form.rt = data.KK3.rt
      this.form.rw = data.KK3.rw
      this.form.kode_pos = data.KK3.kode_pos
      this.form.Telepon = data.KK3.Telepon

      // ===== DATA KK LAMA =====
      this.form.nama_kepala_keluarga_lama = data.KK3.nama_kepala_keluarga_lama
      this.form.no_kk_lama = data.KK3.no_kk_lama
      this.form.alamat_keluarga_lama = data.KK3.alamat_keluarga_lama
      this.form.rt_lama = data.KK3.rt_lama
      this.form.rw_lama = data.KK3.rw_lama
      this.form.provinsi_lama = data.KK3.provinsi_lama
      this.form.kabupaten_lama = data.KK3.kabupaten_lama
      this.form.kecamatan_lama = data.KK3.kecamatan_lama
      this.form.desa_kelurahan_lama = data.KK3.desa_kelurahan_lama
      this.form.kode_pos_lama = data.KK3.kode_pos_lama
      this.form.telepon_lama = data.KK3.telepon_lama

      // ===== ANGGOTA KELUARGA =====
      this.form.anggota_keluarga = data.databio || []

      // ===== STATUS DAN VERIFIKASI =====
      this.form.status = data.KK3.status
      this.form.keterangan = data.KK3.keterangan
      this.form.keterangan_deskel = data.KK3.keterangan_deskel
      this.form.keterangan_kecamatan = data.KK3.keterangan_kecamatan
      this.form.keterangan_kabupaten = data.KK3.keterangan_kabupaten
      this.form.status_deskel = data.KK3.status_deskel
      this.form.status_kecamatan = data.KK3.status_kecamatan
      this.form.status_kabupaten = data.KK3.status_kabupaten
      this.form.createdBy = data.KK3.createdBy
      this.form.createdAt = data.KK3.createdAt
      this.form.createdAt_deskel = data.KK3.createdAt_deskel
      this.form.createdAt_kecamatan = data.KK3.createdAt_kecamatan
      this.form.createdAt_kabupaten = data.KK3.createdAt_kabupaten

      // ===== EMAIL DAN FILE =====
      this.form.emailPemohon = data.KK3.emailPemohon
      this.form.email_fileOld = data.KK3.email_file
      this.form.email_from = this.form.email_from
      this.form.email_to = this.form.emailPemohon
      this.form.email_subject = data.KK3.email_subject
      this.form.email_html = data.KK3.email_html || ''
      this.form.file = data.KK3.file
      this.form.fileThumb = data.KK3.fileThumb
      this.form.file_lampiran = data.KK3.file_lampiran
      this.form.file_lampiranOld = data.KK3.file_lampiranOld

      // ===== WILAYAH INFO UNTUK DISPLAY =====
      this.wilayah = {
    ...
    cekButton_status_kecamatan: function(data){  
      var a = data.KK3.status 
      var status_kab = data.KK3.status_kabupaten  
