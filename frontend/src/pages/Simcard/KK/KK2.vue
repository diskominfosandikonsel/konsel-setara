              ...
              <div class="row items-center no-wrap">
                ...
                <div class="" style="margin-left: 11px;">
                  ...
                  <div class="text-right" style="margin: 0px 0px 0px 0px ;">
                    ...
                    <q-btn class="text-right" v-show="item.KK2.email_file == null && item.KK2.status_kabupaten == '' || item.KK2.status_kabupaten == 2" color="primary" icon="settings">
                      <q-menu>
                        <q-list>
                          <q-item clickable v-close-popup @click="selectData(item), modal_lihat = true ">
                            <q-item-section avatar>
...
export default {
  ...
  methods: {
    ...
    getview() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KK_WNI + "view",
        payload,
        {
          headers: {
    ...
    editData() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KK_WNI + "editData",
        formData,
        {
          headers: {
            authorization: "kikensbatara " + this.token
    ...
    removeData() {
      ...
      axios.post(
        this.simcard.url.URL_PERMOHONAN_KK_WNI + "removeData_mobile",
        body,
        {
          headers: {
            authorization: "kikensbatara " + this.token
