<template>
  <q-page class="panel-bg">
    ...
    <div class="row items-center q-px-sm q-py-md bg-white border-bottom sticky-header">
      ...
      <div class="header-title q-ml-sm text-uppercase text-dark">Panel Perusahaan</div>
      <q-space />
      <q-btn flat round dense icon="logout" color="dark" size="18px" @click="confirmLogout" />
    </div>
